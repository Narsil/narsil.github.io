...
My second guess was [Fairseq](https://github.com/facebookresearch/fairseq) from facebook. In their example there is an actual example for multilingual German, French, English. Close enough for my needs. First things first, start to follow the example by the book. Most implementations out there are broken and won't work out of the box.

This time, it turned out particularly smooth. Clone the repo then follow the [instructions](https://github.com/facebookresearch/fairseq/tree/main/examples/translation#multilingual-translation)
